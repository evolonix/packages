...
export class E {
  constructor(public d: D, public title = 'E') {}
}
export class F {
  constructor(public e: E, public a: A) {}
}
export class G {
  constructor(public b: B, public title = 'G') {}
}
export class H {
...
export class Facade {
  constructor(public store: Store, public query: Query) {}
}
